...
const DAMAGE = preload("res://scenes/PowerUps/types/hero/damage.tres")
const DAMAGE_ENEMY = preload("res://scenes/PowerUps/types/hero/damage_enemy.tres")
const HEALTH = preload("res://scenes/PowerUps/types/hero/health.tres")
const SPEED = preload("res://scenes/PowerUps/types/hero/speed.tres")
const SPEED_ENEMY = preload("res://scenes/PowerUps/types/hero/speed_enemy.tres")
var cartas = [DAMAGE, DAMAGE_ENEMY, HEALTH, SPEED, SPEED_ENEMY]
